...
public class LicensesDialogFragment extends DialogFragment {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mTitleText = resources.getString(R.string.settings_licenses_dialog_title);
            mCloseButtonText = resources.getString(R.string.settings_licenses_dialog_button);
            try {
