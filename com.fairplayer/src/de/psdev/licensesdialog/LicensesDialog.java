...
public class LicensesDialog {
    ...
    public Dialog createAppCompat() {
        ...
        if (mThemeResourceId != 0) {
            builder = new android.app.AlertDialog.Builder(new ContextThemeWrapper(mContext, mThemeResourceId));
        } else {
    ...
    public static final class Builder {
        ...
        public Builder(final Context context) {
            mContext = context;
            mTitleText = context.getString(R.string.settings_licenses_dialog_title);
            mCloseText = context.getString(R.string.settings_licenses_dialog_button);
            mNoticesStyle = context.getString(R.string.settings_licenses_dialog_style);
