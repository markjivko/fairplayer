 ...
 */
public class WidgetBar extends WidgetCommon {
    ...
    public static void updateWidget(Context context, AppWidgetManager manager, FpTrack song, int state) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.fp_widget_bar);
        ...
        do {
            ...
            views.setViewVisibility(R.id.fp_previous, View.INVISIBLE);
            views.setViewVisibility(R.id.fp_play_pause, View.INVISIBLE);
            views.setViewVisibility(R.id.fp_next, View.INVISIBLE);
            views.setViewVisibility(R.id.fp_cover, View.INVISIBLE);
            
            // Nothing here
            if (!FpServiceRendering.hasInstance() || null == song) {
                // Set the background
                views.setImageViewResource(R.id.fp_widget_background, R.drawable.fp_widget_preview_bar);
            ...
            views.setViewVisibility(R.id.fp_previous, View.VISIBLE);
            views.setViewVisibility(R.id.fp_play_pause, View.VISIBLE);
            views.setViewVisibility(R.id.fp_next, View.VISIBLE);
            views.setViewVisibility(R.id.fp_cover, View.VISIBLE);
            
            // Set the background
            views.setImageViewBitmap(R.id.fp_widget_background, FpServiceRendering.getThemedBitmap(R.drawable.fp_bg_widget_bar));
        ...
        // Update the widget
        manager.updateAppWidget(new ComponentName(context, WidgetBar.class), views);
    }
}
