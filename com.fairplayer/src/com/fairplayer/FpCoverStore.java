...
public class FpCoverStore {

    /**
     * Returned size of small album covers
     * This is 44sp * 2 = xhdpi resolution. We should probably calculate this
     * dynamically
     */
    ...
    /**
     * Use musics cover load mechanism
     */
    public static final int COVER_MODE_CUSTOM = 0x2;
    /**
     * Use musics SHADOW cover load mechanism
     */
     ...
     */
    public FpCoverStore(Context context) {
    ...
    /**
     * Returns a (possibly uncached) cover for the song - will return null if
     ...
     */
    public Bitmap getCoverFromSong(FpTrack song, int size) {
        CoverKey key = new FpCoverStore.CoverKey(FpUtilsMedia.TYPE_ALBUM, song.albumId, size);
    ...
    private static class BitmapDiskCache extends SQLiteOpenHelper {
         ...
         * SQLite table to use
         */
        private final static String TABLE_NAME = "fp_database_cover";
        /**
         ...
         * @param maxPxCount the maximum amount of pixels to return (30*30 =
         * 900)
         */
        public Bitmap createBitmap(FpTrack song, long maxPxCount) {
            if (song.id < 0) {
            ...
            try {
                ...
                if ((FpCoverStore.mCoverLoadMode & FpCoverStore.COVER_MODE_CUSTOM) != 0) {
                ...
                if (inputStream == null && (FpCoverStore.mCoverLoadMode & FpCoverStore.COVER_MODE_SHADOW) != 0) {
                    String shadowPath = "/sdcard/Music/.fp/" + (song.artist.replaceAll("/", "_")) + "/" + (song.album.replaceAll("/", "_")) + ".jpg";
                ...
                if (inputStream == null && (FpCoverStore.mCoverLoadMode & FpCoverStore.COVER_MODE_ANDROID) != 0) {
