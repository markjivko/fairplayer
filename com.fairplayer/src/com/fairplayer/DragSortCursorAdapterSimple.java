 ...
 */
public class DragSortCursorAdapterSimple extends DragSortCursorAdapterResource {
     ...
     */
    @Deprecated
    public DragSortCursorAdapterSimple(Context context, int layout, Cursor c, String[] from, int[] to) {
     ...
     */
    public DragSortCursorAdapterSimple(Context context, int layout,
                ...
                if (!bound) {
                    ...
                    if (v instanceof TextView) {
                        ...
                        if (v instanceof ImageView) {
                            ...
                            throw new IllegalStateException(v.getClass().getName() + " cannot be bound");
                        }
                    }
                }
            }
